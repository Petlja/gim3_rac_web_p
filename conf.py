...
project = 'Петља - Рачунарство и информатика за трећи разред гимназије - природно-математички смер'
...
html_context = {'course_id': 'gim3_web_prirodni',
...
html_theme_options = {
    ...
    'navbar_title': "Петља - Рачунарство и информатика за трећи разред гимназије - природно-математички смер",
...
html_title = 'Петља - Рачунарство и информатика за трећи разред гимназије - природно-математички смер'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Петља - Рачунарство и информатика за трећи разред гимназије - природно-математички смер'
...
htmlhelp_basename = 'gim3_web_prirodni-doc'
