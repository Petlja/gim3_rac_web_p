...
У неким од задатака који следе, поновићемо табелу која приказује ордење додељено Николи Тесли, а о којој је већ било речи у овој лекцији, да бисте лакше могли да удрадите вежбе.
...
.. questionnote::
    ...
    **Задатак 1.3.3**
    ...
    Допуните дату табелу и додајте и друге ордене које је добио Никола Тесла, тако што ћете за сваки орден убацити по један ред (``<tr>`` ... ``</tr>``) са по три колоне (``<td>`` ... ``</td>``), тако да подаци буду поређани хронолошки. Ордени које треба додати у табелу су:
